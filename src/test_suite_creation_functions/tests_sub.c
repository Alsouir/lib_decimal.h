...
START_TEST(s21_sub_test_4) {
  ...
  value_type_result = s21_sub(src1, src2, &result);
  value_type_origin = 1;
  // origin.bits[0] = 0b11111111111111111111111111111010;
...
START_TEST(s21_sub_test_5) {
  ...
  value_type_result = s21_sub(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b00000000100111101101001101000000;
  origin.bits[1] = 0b11110000000100011010111110001001;
...
START_TEST(s21_sub_test_7) {
  ...
  value_type_result = s21_sub(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b01111101000010100110100001110000;
  origin.bits[1] = 0b00000001001100101001110111010101;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000001100000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
  ck_assert_int_eq(origin.bits[2], result.bits[2]);
...
START_TEST(s21_sub_test_10) {
  ...
  value_type_result = s21_sub(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b00000000000000000000000000010001;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000000000000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
...
START_TEST(s21_sub_test_14) {
  ...
  value_type_result = s21_sub(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b01111101000010100110100001110001;
  origin.bits[1] = 0b00000001001100101001110111010101;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000001100000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
