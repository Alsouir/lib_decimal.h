...
START_TEST(s21_is_equal_test_1) {
  ...
  value_type_result = s21_is_equal(src1, src2);
  value_type_origin = 1;
...
Suite *test_is_equal(void) {
  ...
  tcase_add_test(tc, s21_is_equal_test_16);
  tcase_add_test(tc, s21_is_equal_test_17);
  tcase_add_test(tc, s21_is_equal_test_18);
